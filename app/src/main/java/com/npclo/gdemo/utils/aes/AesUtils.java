package com.npclo.gdemo.utils.aes;
...
public class AesUtils {
    ...
    private String key = "wx62fa1f44fb4aaaf6";

    public AesUtils() {
        aesKey = EncodeUtils.base64Decode("WNKIqVfebYUWIEnQeUbVxFyufBTXza83PEW9uUnEYWn=");
    }
    ...
    private String encrypt(String randomStr, String text) throws AesException {
        ...
        byte[] appidBytes = key.getBytes(CHARSET);
    ...
    private String decrypt(String text) throws AesException {
        ...
        try {
            ...
            // 使用BASE64对密文进行解码
            byte[] encrypted = EncodeUtils.base64Decode(text);
